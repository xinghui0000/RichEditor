...
public class RichEditor extends WebView {
    ...
    public enum Type {
        ...
        public void setValue(Object mValue) {
            switch (this) {
                case FONTSIZE:
                    this.mValue = Integer.parseInt(mValue.toString().replaceAll("[\\D]", ""));
                    break;
                case FORECOLOR:
                    this.mValue = "#" + mValue.toString().split("#")[1];
                    break;
                default:
                    break;
            }
    ...
    public void insertImage(List<Pair<String, String>> pairs, String alt) {
        ...
        try {
            ...
            for (Pair<String, String> pair : pairs) {
                ...
                jsonObject.put("src", pair.second);
                jsonObject.put("uploadpic", pair.first);
                jsonObject.put("alt", alt);
                jsonArray.put(jsonObject);
            }
            exec("javascript:RE.prepareInsert();");
            exec("javascript:RE.insertImageList('" + jsonArray.toString() + "')");
